...
function TechnicalItemCard({
  item,
  badgeLabel,
  typeLabel,
}: {
  item: RematePosTechnicalLink
  badgeLabel: string
  typeLabel: string
}) {
  return (
    <a
      className="group flex h-full flex-col rounded-2xl border border-white/10 bg-slate-950/60 p-4 transition hover:-translate-y-0.5 hover:border-teal-300/30 hover:bg-slate-950/80"
      href={item.url}
      target="_blank"
    ...
    >
      <div className="flex items-start gap-3">
        <span className="grid size-10 shrink-0 place-items-center rounded-2xl border border-white/10 bg-white/6 text-teal-200">
